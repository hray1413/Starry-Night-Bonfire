...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .logo{width:88px;height:88px;border-radius:14px;background:linear-gradient(180deg,#1b2c48,#0b1630);display:flex;align-items:center;justify-content:center;box-shadow:0 6px 18px rgba(0,0,0,0.6), inset 0 -6px 18px rgba(255,255,255,0.02);overflow:hidden}
    ...
    <main>
      <section>
        <div class="card hero">
          ...
          <h3 style="margin-top:14px">畫廊(暫無)</h3>
        ...
        <div class="card">
          ...
          <div style="margin-top:14px">
            ...
            <ol class="rules">
              <li>禁止不當言論與歧視。</li>
              <li>《星夜篝火》伺服器規則</li>
              <li>為了讓大家有最好的遊玩體驗，請遵守以下規則：</li>
              <li>禁止破壞他人建築 —— 尊重每位玩家的心血成果</li>
              <li>禁止外掛 / 非法模組 —— 公平遊戲，拒絕作弊</li>
              <li>禁止刷屏與廣告 —— 保持頻道整潔，不打擾他人</li>
              <li>禁止辱罵、騷擾 —— 友善交流，營造良好氛圍</li>
              <li>合作共建，互助分享 —— 鼓勵玩家一起冒險與建設</li>
              <li>發現問題請回報管理員 —— 共同維護伺服器環境</li>
              <li>遵守規則，大家都能享受一個 溫馨、自由、充滿樂趣 的世界！</li>
            </ol>
          ...
          <div style="margin-top:12px">
            <h4>開啟時間</h4>
            <p class="rules">每天00:00分重啟(本地時間)。</p>
          </div>

          <div style="margin-top:12px">
            <h4>伺服器版本</h4>
            <p class="rules">Minecraft Java 1.21.8 ~ java1.8.9（建議使用相同次版本）</p>
          </div>
